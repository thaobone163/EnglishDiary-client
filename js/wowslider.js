...
jQuery.fn.wowSlider = function (C) {
    ...
    if (S) {
        S.css({
            ...
            outline: "none"
        }).attr({href: "http://" + d.toLowerCase()}).html(d).bind("contextmenu", function (c) {
            return false
    ...
    var R = {
        none: function (f, c) {
            ...
            R.array([{left1: "100%", top2: "100%"}, {left1: "80%", left2: "-50%"}, {
                top1: "-100%",
                top2: "100%",
                distance: 0.7,
                easing: "easeOutBack"
    ...
    function n(ak, ao, c, am, ai) {
        ...
        function al(aq) {
            ...
            J(aj[aq]).css({visibility: "visible"}).css({opacity: 0}).animate({opacity: ar}, ai, "easeOutCirc").animate({
                top: 0,
                left: 0
            }, {duration: ai, easing: (ao.easing || am), queue: false})
        }
    ...
    function V(an, aq) {
        ...
        an.animate(al, {
            queue: false, duration: aq.duration, easing: aq.easing, complete: function () {
                an.css(ap);
